...
if (isset($_POST['listCat']) AND isset($_POST['listSubCat']) AND isset($_POST['listFour']) and isset($_POST['nom']) AND isset($_POST['reference']) AND isset($_POST['prix']) AND isset($_POST['desc']) AND isset($_POST['qte']) AND isset($_POST['photo']) AND isset($_POST['promo'])) {
    ...
    $req = $bdd->prepare('INSERT INTO product(reference,label,category,subcategory,manufacturer,price,quantity,addeddate,description,photo,promo) 
                    VALUE (:reference,:label,:category,:subcategory,:manufacturer,:price,:quantity,:addeddate,:description,:photo,:promo)');
        ...
        <div class='container'>
            <div class='row'>
                <div class='col-md-6'>
                    ...
                    <span data-notify=\"message\">Votre produit a été ajouté avec succès!</span><a href=\"#\" target=\"_blank\" data-notify=\"url\"></a>
                     </div>
          ...
          <li class="nav-item active">
            ...
            <div class="collapse show" id="tablesExamples">
              <ul class="nav">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="AjouterProduit.php" style="background-color:red;">
                    <span class="sidebar-mini"> A </span>
                    <span class="sidebar-normal"> Ajouter </span>
                  </a>
                </li>
          ...
          <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
              <div class="container-fluid">
                  <div class="navbar-wrapper">
                      ...
                      <a class="navbar-brand" href="#pablo">Ajouter Produit</a>
                  </div>
              </div>
          </nav>
          <div class="content">
              <div class="container-fluid">
                  <div class="row">
                      <div class="col-md-12">
                          <form id="TypeValidation" class="form-horizontal" action="AjouterProduit.php" method="post">
                              <div class="card ">
                           ...
                           <!--<div class="col">
                                  ...
                                  <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                      ...
                                      <div>
                                                    ...
                                                    <input type="hidden"><input type="file" name="photo" value="image_placeholder.jpg">
                  ...
                  <div class="card-footer ml-auto mr-auto">
                      <button type="submit" class="btn btn-primary" style="background-color:red;">Valider</button>
                  </div>
              </div>
              </form>
          </div>
