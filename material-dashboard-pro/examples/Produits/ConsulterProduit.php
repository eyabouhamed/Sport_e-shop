      ...
      <div class="sidebar-wrapper">
        <div class="user">
          ...
          <li class="nav-item active">
            <a class="nav-link" data-toggle="collapse" href="#produit" aria-expanded="true">
              <i class="material-icons">grid_on</i>
              <p> Les produits
                <b class="caret"></b>
              </p>
            </a>
            <div class="collapse show" id="produit">
              <ul class="nav">
                <li class="nav-item active">
                  <a class="nav-link" href="ConsulterProduit.php" style="background-color:red;">
                    <span class="sidebar-mini"> C </span>
                    <span class="sidebar-normal"> Consulter </span>
                  </a>
                </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Table des Produits</a>
          </div>
        </div>
      </nav>
      <div class="content">
                  ...
                  <div class="material-datatables">
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <?php
                       ...
                       $req = $idcom->prepare("SELECT id, reference,label, category,manufacturer,price,quantity,description,photo FROM product ");
                       $req->execute();
                       $req->bind_result($code,$reference,$nom,$categorie,$fournisseur,$prix,$quantitee,$description,$image);
                       while ($req->fetch()) {
                        echo'
                        <tr>
                          <td>'.$code.'</td>
                          ...
                          <td>
                            <form id="'.$code.'">
                             <button type="button" title="Détails" class="btn btn-just-icon btn-round btn-primary"><i class="fa fa-info" style="background-color:black;"></i></button>
                            </form>
                          </td>
                          
                          <td>
                            <form id="editer'.$code.'" action="EditerProduit.php" method="POST">
                             <input type="text" class="form-control"  name="code" value="'.$code.'" style="display:none;">
                             <button type="submit" name="editer" title="Editer les coordonnées" class="btn btn-just-icon btn-round btn-info">
                          ...
                          <td>
                            <form id="supprimer'.$code.'" action="supprimerProduit.php" method="POST" onsubmit=" return confirm(\'voulez-vous vraiment supprimer ce produit ?\') ">
                             <input type="text" class="form-control"  name="code" value="'.$code.'" style="display:none;">
                             <button type="submit" title="Supprimer le produit" class="btn btn-just-icon btn-round btn-danger">
