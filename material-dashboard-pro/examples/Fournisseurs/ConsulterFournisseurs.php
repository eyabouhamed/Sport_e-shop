      ...
      <div class="sidebar-wrapper">
        <div class="user">
          ...
          <li class="nav-item active">
            <a class="nav-link" data-toggle="collapse" href="#fournisseurs" aria-expanded="true">
              <i class="material-icons">local_shipping</i>
              <p> Les Fournisseurs
                <b class="caret"></b>
              </p>
            </a>
            <div class="collapse show" id="fournisseurs">
              <ul class="nav">
                <li class="nav-item active">
          ...
          <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
              <div class="container-fluid">
                  <div class="navbar-wrapper">
                      ...
                      <a class="navbar-brand" href="#pablo">Table des Fournisseurs</a>
                  </div>
              </div>
          </nav>
          <div class="content">
                              ...
                              <div class="card-body">
                                  ...
                                  <div class="material-datatables">
                                      <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                          ...
                                          $req = $idcom->prepare("SELECT id,label,reference,email,phone,country,address1,address2,city,zipcode FROM manufacturer ");
                                          $req->execute();
                                          $req->bind_result($id,$nom,$reference,$email,$phone,$country,$address1,$address2,$city,$zipcode);
                                          while ($req->fetch()) {
                                              echo'
                                  <tr>
                                      <td>'.$id.'</td>
                                      ...
                                      <td>
                                        <form id="'.$id.'">
                                         <button type="button" title="Adresse" class="btn btn-just-icon btn-round btn-red"><i class="material-icons">room</i></button>
                                        </form>
                                      </td>
                                      <td>
                                      <form id="editer'.$id.'" action="EditerFournisseurs.php" method="POST">
                                       <input type="text" class="form-control"  name="id" value="'.$id.'" style="display:none;">
                                       <button type="submit" title="Editer les coordonnées" name="editer" class="btn btn-just-icon btn-round btn-info">
                                        <i class="fa fa-edit" style="background-color:gray;"></i>
                                       </button>
                                      </form>
                                      </td>
                                      <td>
                                      <form id="delete'.$id.'" action="SupprimerFournisseurs.php" method="POST" onsubmit=" return confirm(\'voulez-vous vraiment supprimer ce fournisseur ?\') ">
                                       <input type="text" class="form-control"  name="id" value="'.$id.'" style="display:none;">
                                       <button type="submit" title="Supprimer le Fournisseur" class="btn btn-just-icon btn-round btn-danger">
                                    ...
                                    Swal({title:\'Adresse\', 
                                      html: \'<table class="table table-striped table-no-bordered table-hover"><tr><th>Pays : <td>'.$country.'<td></th></tr><tr><th>Ville : <td>'.$city.'<td></th></tr><tr><th>Adresse1 : <td>'.$address1.'<td></th></tr><tr><th>Adresse2 : <td>'.$address2.'<td></tr><tr><th>ZipCode : <td>'.$zipcode.'<td></th></tr></table>\'
