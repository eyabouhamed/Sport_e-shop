...
if(isset($_POST['clicked'])) {
    $label = htmlspecialchars($_POST['nom']);
    ...
    $req = $bdd->prepare('INSERT INTO manufacturer(label,reference,email,phone,country,address1,address2,city,zipcode) 
                                                VALUE (:label,:reference,:email,:phone,:country,:address1,:address2,:city,:zipcode)');
        ...
        <div class='container'>
            <div class='row'>
                <div class='col-md-6'>
                    ...
                    <span data-notify=\"message\">Votre fournisseur a été ajouté avec succès!</span><a href=\"#\" target=\"_blank\" data-notify=\"url\"></a>
                     </div>
          ...
          <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
              <div class="container-fluid">
                  <div class="navbar-wrapper">
                      ...
                      <a class="navbar-brand" href="#pablo">Ajouter Fournisseur</a>
                  </div>
              </div>
          </nav>
          <div class="content">
                                  ...
                                  <div class="card-body ">
                                      <div class="row">
                                          ...
                                          <div class="col-sm-10">
                                              <div class="form-group">
                                                  <div class="form-group">
                                                      <label for="" class="bmd-label-floating">Nom Fournisseur</label>
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-sm-10">
                                              <div class="form-group">
                                                  <div class="form-group">
                                                      <label for="" class="bmd-label-floating">Reference</label>
