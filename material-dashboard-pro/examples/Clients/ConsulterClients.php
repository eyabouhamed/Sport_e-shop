        ...
        <div class="user">
          ...
          <li class="nav-item active ">
            ...
            <div class="collapse show" id="Clients">
              <ul class="nav">
                <li class="nav-item active">
                  <a class="nav-link" href="ConsulterClients.php" style="background-color:red;">
                    <span class="sidebar-mini"> C </span>
                    <span class="sidebar-normal"> Consulter </span>
                  </a>
                </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Table des Clients</a>
          </div>
        </div>
      </nav>
      <div class="content">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="material-datatables">
                    ...
                    $req = $idcom->prepare("SELECT id,firstname,lastname,cin,email,phone,company,country,address1,address2,city,zipcode,title FROM client ");
                    $req->execute();
                    $req->bind_result($id,$nom,$prenom,$cin,$email,$phone,$company,$country,$address1,$address2,$city,$zipcode,$title);
                    while ($req->fetch()) {
                            echo'
                                  <tr>
                                      <td>'.$id.'</td>
                                      ...
                                      <td>
                                      <form id="editer'.$id.'" action="EditerClients.php" method="POST">
                                      ...
                                      <td>
                                      <form id="delete'.$id.'" action="supprimerClients.php" method="POST" onsubmit=" return confirm(\'voulez-vous vraiment supprimer ce client ?\') ">
                                       <input type="text" class="form-control"  name="id" value="'.$id.'" style="display:none;">
                                       <button type="submit" title="Supprimer le client"  class="btn btn-just-icon btn-round btn-danger">
                            ...
                            echo'      <script type=\'text/javascript\'>
                                    ...
                                    Swal({title:\'Adresse\', 
                                      html: \'<table class="table table-striped table-no-bordered table-hover"><tr><th>Pays : <td>'.$country.'<td></th></tr><tr><th>Ville : <td>'.$city.'<td></th></tr><tr><th>Adresse1 : <td>'.$address1.'<td></th></tr><tr><th>Adresse2 : <td>'.$address2.'<td></th></tr><tr><th>Societé : <td>'.$company.'<td></th></tr><tr><th>ZipCode : <td>'.$zipcode.'<td></th></tr></table>\'
