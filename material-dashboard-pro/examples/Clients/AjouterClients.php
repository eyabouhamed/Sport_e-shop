...
if(isset($_POST['clicked'])) {
    ...
    /*$mm=substr($Birthday,0,2);
    $dd=substr($Birthday,3,2);
    $yy=substr($Birthday,6,2);
    $Birthday=$yy.'-'.$mm.'-'.$dd;*/

    $req = $bdd->prepare('INSERT INTO client(firstname,lastname,cin,email,passwd,phone,company,country,address1,address2,city,zipcode,title) 
                    VALUE (:firstname,:lastname,:cin,:email,:passwd,:phone,:company,:country,:address1,:address2,:city,:zipcode,:title)');
        ...
        <div class='container'>
            <div class='row'>
                <div class='col-md-6'>
                    ...
                    <span data-notify=\"message\">Votre client a été ajouté avec succès!</span><a href=\"#\" target=\"_blank\" data-notify=\"url\"></a>
                     </div>
          ...
          <li class="nav-item active ">
            ...
            <div class="collapse show" id="Clients">
              <ul class="nav">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="AjouterClients.php" style="background-color:red;"></a>
                    <span class="sidebar-mini"> A </span>
                    <span class="sidebar-normal"> Ajouter </span>
                  </a>
                </li>
          ...
          <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
              <div class="container-fluid">
                  <div class="navbar-wrapper">
                      ...
                      <a class="navbar-brand" href="#pablo">Ajouter Client</a>
                  </div>
              </div>
          </nav>
          <div class="content">
              <div class="container-fluid">
                  <div class="row">
                      <div class="col-md-12">
                          <form id="TypeValidation" class="form-horizontal" action="AjouterClients.php" method="post">
                              <div class="card ">
                                  ...
                                  <div class="card-body ">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-sm-10">
                                              <div class="form-group">
                                                  <div class="form-group">
                                                      <label for="" class="bmd-label-floating">Prénom</label>
                                      ...
                                      <!--<div class="row">
                                          ...
                                          <div class="col-sm-10">
                                              <div class="form-group">
                                                  ...
                                                  <br>
                                                  <input type="text" class="form-control datepicker" name="dateC" value="01/01/2020">
                                              </div>
                                          </div>
                                      </div>-->
                                      <div class="row">
                                  ...
                                  <div class="row">
                                          ...
                                          <div class="col-sm-10">
                                              <div class="form-group">
                                                  <div class="form-group">
                                                      <label for="" class="bmd-label-floating">Numéro telephone</label>
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-sm-10">
                                              <div class="form-group">
                                                  <div class="form-group">
                                                      <label for="" class="bmd-label-floating">Societé</label>
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col">
                                              <div class="form-group">
                                                  <div class="form-group">
<!--                                                      <label for="" class="bmd-label-floating">Civilité</label>-->
<!--                                                      <input type="text" name="title" class="form-control" id=""-->
<!--                                                             required="true">-->
                                                      <select class="selectpicker" name="listCivilte[]"
                                                              data-style="select-with-transition" single
                                                              title="Choisissez Civilité" data-size="7" required="true">
                                  ...
                                  <div class="card-footer ml-auto mr-auto">
                                      <button type="submit" name="clicked" class="btn btn-primary" style="background-color:red;">Valider</button>
                                  </div>
                            </div>
                          </form>
                      </div>
