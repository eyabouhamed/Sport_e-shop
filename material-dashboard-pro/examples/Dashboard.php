      ...
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          <li class="nav-item active ">
            <a class="nav-link" href="Dashboard.php" style="background-color:red;">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="card card-product">
                              <div class="card-header card-header-image" data-header-animation="true">
                                <a href="#pablo">
                                  <img class="img" src="../assets/img/jordan.jpeg">
                                </a>
                              </div>
                              <div class="card-body">
                                ...
                                <h4 class="card-title">
                                  <a href="#pablo">Nike Air Zoom SuperRep</a>
                                </h4>
                                <div class="card-description">
                                    The Nike Air Zoom SuperRep is designed for circuit training, HIIT, short runs and other fast-paced exercise.
                                </div>
                              </div>
                              <div class="card-footer">
                                <div class="price">
                          ...
                          <div class="col-md-4">
                            <div class="card card-product">
                              <div class="card-header card-header-image" data-header-animation="true">
                                <a href="#pablo">
                                  <img class="img" src="../assets/img/horn.jpg">
                                </a>
                              </div>
                              <div class="card-body">
                                <div class="card-actions text-center">
                                ...
                                <h4 class="card-title">
                                  <a href="#pablo">Jordan Aerospace 720</a>
                                </h4>
                                <div class="card-description">
                          ...
                          <div class="col-md-4">
                            <div class="card card-product">
                              <div class="card-header card-header-image" data-header-animation="true">
                                <a href="#pablo">
                                  <img class="img" src="../assets/img/swrn.jpg">
                                </a>
                              </div>
                              <div class="card-body">
                                <div class="card-actions text-center">
                                ...
                                <h4 class="card-title">
                                  <a href="#pablo">Nike Air Force 1 '07 WB</a>
                                </h4>
                                <div class="card-description">
...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 12:39:53 GMT -->
</html>
